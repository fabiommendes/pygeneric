    ...
    def __new__(cls, arg):
        ...
        try:
            ...
            raise SyntaxError('ForwardRef must be an expression -- got %r' %
                              (arg,))
        self = super(_ForwardRef, cls).__new__(cls, arg, (), {}, _root=True)
...
class AnyMeta(TypingMeta):
    ...
    def __new__(cls, name, bases, namespace, _root=False):
        self = super(AnyMeta, cls).__new__(cls, name, bases, namespace, _root=_root)
        return self
    ...
    def __subclasscheck__(self, cls):
        if not isinstance(cls, type):
            return super(AnyMeta, self).__subclasscheck__(cls)  # To TypeError.
        return True
...
class TypeVar(TypingMeta, _root=True):
    ...
    def __new__(cls, name, *constraints, **_3to2kwargs):
        ...
        self = super(TypeVar, cls).__new__(cls, name, (Final,), {}, _root=True)
...
class UnionMeta(TypingMeta):
    ...
    def __new__(cls, name, bases, namespace, parameters=None, _root=False):
        if parameters is None:
            return super(UnionMeta, cls).__new__(cls, name, bases, namespace, _root=_root)
        ...
        self = super(UnionMeta, cls).__new__(cls, name, bases, {}, _root=True)
...
class OptionalMeta(TypingMeta):
    ...
    def __new__(cls, name, bases, namespace, _root=False):
        return super(OptionalMeta, cls).__new__(cls, name, bases, namespace, _root=_root)
...
class TupleMeta(TypingMeta):
    ...
    def __new__(cls, name, bases, namespace, parameters=None,
        ...
        self = super(TupleMeta, cls).__new__(cls, name, bases, namespace, _root=_root)
...
class CallableMeta(TypingMeta):
    ...
    def __new__(cls, name, bases, namespace, _root=False,
        ...
        self = super(CallableMeta, cls).__new__(cls, name, bases, namespace, _root=_root)
        self.__args__ = args
